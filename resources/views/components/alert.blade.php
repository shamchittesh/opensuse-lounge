...
@php
$types = [
    'success' => 'bg-alert-success/5 border-alert-success text-alert-success',
    'error' => 'bg-alert-error/5 border-alert-error text-alert-error',
    'warning' => 'bg-alert-warning/5 border-alert-warning text-alert-warning',
    'info' => 'bg-alert-info/5 border-alert-info text-alert-info',
];
...
<div x-data="{ show: true }" 
     ...
     class=" mt-4">
    <div {{ $attributes->merge(['class' => 'rounded-lg border p-4 flex items-start ' . $types[$type]]) }}>
        ...
        @if($dismissible)
            <button @click="show = false" class="flex-shrink-0 ml-4 inline-flex text-current hover:opacity-75 focus:outline-none">
