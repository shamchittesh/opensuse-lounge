...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            @if($canExportMembers)
                <x-button href="{{ route('members.export', ['q' => request('q')]) }}" variant="secondary">
    ...
    <div class="flex justify-end">
        <form action="{{ route('members.index') }}" method="GET" x-target.push="members-table" class="w-full sm:w-96">
            <x-input
                name="q"
                type="text"
                placeholder="Search members by username, email, or nick..."
                :value="request('q')"
